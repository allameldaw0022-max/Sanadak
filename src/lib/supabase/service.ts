...
// client components, never exposed to the browser. This is what lets
// audit.ts write security_events and rate-limit.ts write
// security_rate_limits even though both are intentionally unwritable
// through the normal RLS-governed, user-session client.
